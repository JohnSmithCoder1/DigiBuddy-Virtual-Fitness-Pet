...
DigiBuddy does not require an account or login. DigiBuddy does not collect, transmit, or store any personal information outside of your device. It does not use any third-party analytics software, social media integrations, or web links. DigiBuddy does not access your device's email, phone, or webcam features.
...
Access to HealthKit data is entirely optional and can be granted or denied per category within Apple Health settings. DigiBuddy does not transmit, store, or share HealthKit data with any external servers, third parties, or other apps.
